...
#define IN1   4  // Replace the ? with the GPIO pin you selected to connect IN1
#define IN2   5   // Replace the ? with the GPIO pin you selected to connect IN2
#define A  6 // Replace the ? with the GPIO pin you selected to connect encoder A
#define B  7 // Replace the ? with the GPIO pin you selected to connect encoder B
...
void setup() {
  ...
  Serial.println("DC Motor with Encoder Control Ready");
  Serial.println("Send commands:0, 25, 50, 75, 100");
}
